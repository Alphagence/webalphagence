...
const ImmersiveHeroSection = () => {
  ...
  return <ScrollExpandMedia mediaType="video" mediaSrc="/2025-05-20-15_44_19.mp4" bgImageSrc="/lovable-uploads/fb79ecdd-06c0-45df-9f81-e2f90615b669.png" title="Un site moderne et performant" date="Adapté aux besoins des PME" scrollToExpand="Défiler pour découvrir" textBlend>
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col gap-3 sm:gap-4 items-center justify-center w-full">
            ...
            <Button asChild variant="outline" className="border-alphagence-gold text-alphagence-gold hover:bg-alphagence-gold/10 text-base sm:text-lg py-4 sm:py-6 px-6 sm:px-8 w-full max-w-xs sm:max-w-none sm:w-auto">
              <a href="https://www.alphagence.com" target="_blank" rel="noopener noreferrer">Consulter toutes nos offres</a>
            </Button>
          </div>
        </div>
      </div>
