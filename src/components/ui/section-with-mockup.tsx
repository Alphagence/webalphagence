    ...
    return (
        <section className="relative py-24 md:py-48 bg-black overflow-hidden">
            <div className="container max-w-[1220px] w-full px-6 md:px-10 relative z-10 mx-auto">
                ...
                >
                    ...
                    >
                        ...
                        {/* Main Mockup Card */}
                        <motion.div
                            className="relative w-full h-[405px] md:h-[637px] bg-[#ffffff0a] rounded-[32px] backdrop-blur-[15px] backdrop-brightness-[100%] border border-alphagence-gold/20 z-10 overflow-hidden"
                            initial={{ y: reverseLayout ? 0 : 0 }}
                            whileInView={{ y: reverseLayout ? 20 : 30 }}
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(50% 50% at 50% 50%, rgba(184,141,87,0.24) 0%, rgba(184,141,87,0) 100%)",
                }}
            />
        </section>
    );
