...
const StatsSection = () => {
  ...
  return <section ref={sectionRef} className="py-20 bg-black relative overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 max-w-6xl mx-auto">
          {stats.map((stat, index) => <div key={index} className="animate-on-scroll text-center p-6 rounded-xl border border-gray-700 bg-[#b08d57]/[0.53]">
              <div className="text-4xl font-bold text-alphagence-gold mb-2">
                <AnimatedCounter target={stat.target} suffix={stat.suffix} duration={2000 + index * 200} />
              </div>
