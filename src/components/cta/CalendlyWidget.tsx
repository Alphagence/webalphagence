const CalendlyWidget = () => {
  return <div className="animate-on-scroll rounded-xl p-6 backdrop-blur-sm border border-gray-700 bg-[#b08d57]/[0.26]">
      ...
      <div className="calendly-inline-widget bg-white rounded-lg" data-url="https://calendly.com/alphameed/rendez-vous-informations-et-renseignements?hide_event_type_details=1&hide_gdpr_banner=1" style={{
      minWidth: '320px',
      height: '700px'
    }}></div>
    </div>;
