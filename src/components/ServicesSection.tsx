...
const ServiceCard = ({
  ...
  }} className="animate-on-scroll rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-800 hover:border-alphagence-gold/20 bg-[#b08d57]/[0.61]">
